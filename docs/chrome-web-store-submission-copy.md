...
現時点の公開URLとして、サポートURLはGitHub Issues、プライバシーポリシーURLはGitHub上の公開Markdownを使います。紹介LPを公開した後は、プライバシーポリシーURLをLP側の固定ページへ差し替える想定です。
...
- プライバシーポリシーURL: 紹介LPを公開した後、LP側のプライバシーポリシー固定ページへ差し替える。
- Homepage URL: 紹介LP公開後に設定する。
